...
parser.add_argument(
    ...
    type=open,
    # required=True,
    default="/home/lxy/code/main1/config/config_llm_IQN.json",
...
def run_trial(device,params):
    ...
    cooperative_agent = Agent(cooperative=True,device=device,use_iqn=params["use_iqn"],use_llm=params["use_llm"],seed=params["seed"]+100)
...
if __name__ == "__main__":
    ...
    params = json.load(args.config_file)  # 加载IQN实验设置
